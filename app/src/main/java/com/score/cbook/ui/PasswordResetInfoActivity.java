...
public class PasswordResetInfoActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.password_reset_info_activity);
    ...
    private void navigateToQuestion() {
        Intent intent = new Intent(PasswordResetInfoActivity.this, PasswordResetQuestionActivity.class);
